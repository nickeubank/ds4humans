...
In this section, we will work on a longer example to illustrate what "getting the problem wrong, then adapting and getting it right" looks like in practice.

## Pizza Ltd. Advertising

Pizza Ltd. is a (fictitious) pizza delivery chain interested in improving its online sales. Last year, they increased their online advertising budget threefold, but saw almost no change in their online sales, despite an increase in in-store sales.

You have been hired to help improve the effectiveness of their advertising. Pizza Ltd. provides you with data on its previous advertising campaigns, including ad impressions and clicks broken down by user demographics, geography, and past interactions with Pizza Ltd.

"Well," you reason, "maybe the problem is that Pizza Ltd's ads aren't being shown to the right people. After all, it seems unlikely that any ad for pizza—no matter how appealing—is likely to draw a click if it's shown to a 75-year-old at 7 am." And sure enough, the data provided by Pizza Ltd shows they aren't doing much ad targeting — their ads are being shown to an extremely diverse set of users, including many who probably aren't that interested in pizza!

Using the provided data, you train a model to answer the question: "given a user's demographics and online behavior, how likely are they to click on a Pizza Ltd. ad?" You try out a few different models, tune the model parameters, and eventually settle on a neural network model with extremely high precision *and* recall. Hooray!
...
You hand over your model to Pizza Ltd, who immediately reallocate their ads based on your model. Within a week, Pizza Ltd. sees the share of ad impressions that result in clicks and pizza purchases increase fivefold. Everyone congratulates you, and you move on to the next project feeling very smug.

### The Other Shoe Drops

A few months later, you are called into a meeting with the Pizza Ltd advertising team, online sales team, and the company's Chief Financial Officer (CFO). They've been looking over the numbers, and despite the huge rise in ad clicks, ad clicks per impression, ad clicks per dollar spent, *and* clicks that result in sales, when they crunch their quarterly sales numbers, they find that, to their surprise, overall online sales haven't risen at all. Moreover, in-store sales are stable, searches for Pizza Ltd. haven't declined, and social media sentiment and posting rates all seem stable, suggesting that the lack of overall sales growth isn't due to a decline in demand.
...
First, **how will we know if we're successful?** Implicitly, we assumed we would know we were successful if the number of impressions that led to clicks increased. But as is clear from the concerns raised by Pizza Ltd's advertising team, online sales team, and CFO, the rise in clicks did *not* indicate success.
...
OK, but... we got people to click the ads, right? We show ads, and we hope people click. And we did a great job figuring out how to show the ads to people who would click them! How is this our fault?
...
No — often clicking on an ad is an indicator that the ad has worked, but in focusing on that immediate (and easy to measure) outcome, we're missing the point of ads. So let's abstract our idea of what we're trying to accomplish. Are we trying to get people who see one of our online ads to click it? No. Are we trying to get people who see one of our online ads to click it and buy a pizza? Closer, but still no.
...
[^racketeeringmodel]: To be clear, I'm not saying that paying for ads at the top of Google for the name of one's own company is always a bad idea — they may prevent a competitor pizza chain from buying that spot and convincing the searcher to change their plans and order from the competitor instead. Basically, these ads sometimes amount to paying Google not to sell your business to someone else. But that's a nuance that's mostly a distraction at this point.
...
This data can then be used to improve targeting by examining differences in purchase rates between the group that saw the ad and the group that didn't across different demographic sub-populations (younger users, men versus women, users in different geographic areas, etc.). And of course, this strategy can also be used to test different ads to figure out which ad is most effective.
