...
For your final project in IDS 701, you and your group should choose substantive problem you care about, identify a Causal Question which, if answered, would help solve said problem, and then set about answering that question to the degree possible.
...
2. The Causal Question you will seek to answer, and how answering that question will help to solve your motivating problem. In specifying your Causal Question, you should be very explicit about your causal factor of interest (your $D$) and your outcome of interest ($Y$).
