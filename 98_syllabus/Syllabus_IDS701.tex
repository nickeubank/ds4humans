...
\subsection{Participation (15\% of Grade)}
...
\subsection{Mid-Term (15\% of Grade) and Final Exam (15\% of Grade)}

After completion of the portion of the class focused on experiments, there will be an in-class, closed-book midterm. Similarly, at the end of the semester there will be an in-class closed-book final exam. The aim of these exams is not to force memorization, or to create an artificial means of grading students. This class is fundamentally about critical thinking, and to be useful it is not enough that students know the material when they have their notes in front of them; to be impactful, students must understand the concepts covered well enough to recognize their relevance in new contexts, and that requires a level of familiarity that requires a closed book exam.
...
\subsection{Reading Reflections \& Quizzes (15\% of Grade)}
...
The causal evidence from the teaching and learning field clearly shows that learning outcomes are worse when students have laptops in the classroom. You can find an excellent summary of \href{https://www.nytimes.com/2017/11/22/business/laptops-not-during-lecture-or-meeting.html?unlocked_article_code=1.DFA.c91Z.YUS6LMOLRdv9&smid=url-share}{this research here.}

This appears to be due in part to computers allowing students to become easily distracted (e.g. Facebook), and also in part because significant information synthesis occurs when we take notes by hand because we are not fast enough writers to transcribe everything being said.  Most typists, on the other hand, can conceivably transcribe word for word for what's being said, but this requires little to no mental processing of the information.\footnote{If you'd like to do more reading than just that op-ed linked above, see \href{https://brucehayes.org/Teaching/papers/MuellerAndOppenheimer2014OnTakingNotesByHand.pdf}{Mueller and Oppenheimer (2014, \emph{The Pen Is Mightier Than the Keyboard: Advantages of Longhand Over Laptop Note Taking})}, \href{https://www.sciencedirect.com/science/article/abs/pii/S0272775716307129}{Patterson and Patterson (2017, \emph{Computers and productivity: Evidence from laptop use in the college classroom})}. \href{https://www.sciencedirect.com/science/article/abs/pii/S0360131506001436}{Fried (2007, \emph{In-class laptop use and its effects on student learning})} and  \href{https://www.ncbi.nlm.nih.gov/pubmed/28182528}{Ravizza et. al. (2017, \emph{Logged In and Zoned Out})} are also worth reading.}
