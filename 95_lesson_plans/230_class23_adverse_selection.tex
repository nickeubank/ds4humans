...
\begin{frame}[c]\frametitle{Kelly Blue Book Exercise}
...
\begin{frame}
    \frametitle{How Kelly Blue Book Estimates Prices}

Kelly Blue Book records used car sales and reports prices based on:


\begin{itemize}
\item Make (e.g., Toyota, Ford)
\item Model (e.g., Camry, F150)
\item Trim (the specific options the car came with, like "Limited" or "SE")
\item Model Year
\item Mileage on the car (how far it's been driven in its life)
\item Condition, divided into Excellent, Very Good, Good, and Fair.
\end{itemize}
\pause Condition is obviously one of the trickier categories, but Kelly Blue Book has a pretty good questionnaire that asks about things like odor, maintenance records, paint chips, etc.
\end{frame}

\begin{frame}
    \frametitle{Kelly BB Plan}
...
If they offer a little below market, they can make money!
\end{frame}
