...
\begin{itemize}
    \pause \item Do you think this result is likely to hold if rolled out to all users \alert{over the long run?} Why or why not?
\end{itemize}
\end{frame}
...
\begin{itemize}
    \pause \item Financial fraud: keeping purchases under \$10,000, or stealing tiny amounts from lots of accounts.
    \pause \item Content policing: ``unalive,'' ``seggs''
    \pause \item Surge pricing: drivers who coordinate to create apparent driver ``shortages'' by all signing off.
\end{itemize}
\end{frame}
