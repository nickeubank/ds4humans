...
Durham Hard Cider Company (DHCC) has a new hard cider. Available Durham restaurants, but sales are weak. \\[1ex]
 ...
 \pause DHCC offered free samples in randomly selected Durham restaurants. Sales of new cider \alert{jumped 30\% in following weeks}. \\[1ex]
...
Apple offers a \$300 discount on laptops in a randomly selected set of cities. \\[1ex]
...
A national used car dealership chain offers \$1,000 discount at locations in a random set of cities. \\[1ex]
...
A/B testing shows promoting these pages increases user recipe searches over 1 month period. \\[1ex]
