...
# 
# You may have never noticed this before, but this is how most news articles are written: one of the first two or three paragraphs is what's referred to as the "nut graf" (or nutshell paragraph) in which the journalist basically summarizes the entire news article in a single paragraph. In the words of [Ken Wells from the Wall Street Journal](https://www.poynter.org/archive/2003/the-nut-graf-part-i/), the nut graf is "a paragraph that says what this whole story is about and why you should read it. It’s a flag to the reader, high up in the story: You can decide to proceed or not, but if you read no farther, you know what that story’s about.
# 
