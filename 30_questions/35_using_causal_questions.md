...
Enter *Causal Questions*. Causal Questions ask what *effect* we can expect from *acting* — that is, *manipulating* or *intervening* — in the world around us. For example, if we pay to show an ad to a specific customer, what will the *effect* of that choice be the likelihood they buy something on our website? Or if we choose to give a new drug to a patient, what will the *effect* of that choice be on their disease?
