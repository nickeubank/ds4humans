...
Now if you're reading this in 2026 or later, you will probably notice LLMs tend not to be quite so silly any more — more recent models have been refined a great deal by having humans rate different responses and using that to tweak the model, and by improvements in how we prompt our models. Nevertheless, it's a good example of the type of issue that arrises without careful attention.
